...
from als_deprecated.prompt_context import load_repo_memory_snapshot
from als_deprecated.transcript_card_metadata import normalize_transcript_card_record
