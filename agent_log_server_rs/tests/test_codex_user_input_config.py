...
class CodexUserInputConfigTests(unittest.TestCase):
    def test_default_is_enabled_without_te2(self) -> None:
        self.assertEqual(
            ...
            {"features": {"default_mode_request_user_input": True}, "include_collaboration_mode_instructions": False},
        )
    ...
    def test_explicit_disable_and_unrelated_features_survive(self) -> None:
        ...
        self.assertEqual(result, {**config, "include_collaboration_mode_instructions": False})
    ...
    def test_does_not_mutate_existing_features(self) -> None:
        ...
        self.assertEqual(result, {"features": {"other": True, "default_mode_request_user_input": True}, "include_collaboration_mode_instructions": False})
